...
function getEmojiForType(type) {
  ...
  if (normType.includes('tumor') || normType.includes('anomalia')) return '🥔';
  if (normType.includes('fenestra') || normType.includes('sapo')) return '🐸';
  if (normType.includes('cachorro') || normType.includes('dog')) return '🐶';
